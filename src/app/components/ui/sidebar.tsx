...
function SidebarProvider({
  ...
  return (
    <SidebarContext.Provider value={contextValue} data-oid="i1wj---">
      <TooltipProvider delayDuration={0} data-oid="h:butwr">
        <div
    ...
    return (
      <Sheet
        ...
        <SheetContent
          ...
          <SheetHeader className="sr-only" data-oid="cq-34gb">
            <SheetTitle data-oid="qh:fh-k">Sidebar</SheetTitle>
            <SheetDescription data-oid="edtv1-k">
              Displays the mobile sidebar.
            </SheetDescription>
          </SheetHeader>
          <div className="flex h-full w-full flex-col" data-oid="xj-yavu">
            {children}
          </div>
        </SheetContent>
      </Sheet>);
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      <PanelLeftIcon data-oid="u-fq-dr" />
      <span className="sr-only" data-oid="w-l7h4c">
        Toggle Sidebar
      </span>
    </Button>);
...
function SidebarMenuButton({
  ...
  return (
    <Tooltip data-oid="dprqmt5">
      <TooltipTrigger asChild data-oid="qvn61mf">
        {button}
      </TooltipTrigger>
      <TooltipContent
        side="right"
