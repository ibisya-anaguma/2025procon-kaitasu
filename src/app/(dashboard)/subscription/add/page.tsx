...
export default function SubscriptionAddPage() {
  ...
  const { onUpdateProductQuantity, onSaveSubscriptionEntry, selectedSubscriptionProduct: product } = useAppContext();
          ...
          <div
            ...
            {product ? (
              <div className="flex flex-col items-center" style={{ gap: "30px" }}>
                ...
                <div style={{ width: "768px", height: "2px", background: "#ADADAD" }} data-oid="subscription-add-divider-1" />
                <div
                  style={{
                    display: "flex",
                    width: "768px",
                  ...
                  <div
                    ...
                    style={{ width: "293px", justifyContent: "space-between" }}
                ...
                <div style={{ width: "768px", height: "2px", background: "#ADADAD" }} data-oid="subscription-add-divider-2" />
                <div
                  style={{
                    display: "flex",
                    width: "768px",
                ...
                <div style={{ width: "768px", height: "2px", background: "#ADADAD" }} data-oid="subscription-add-divider-3" />
                <div
                  style={{
                    display: "flex",
                    width: "768px",
                  ...
                  <Button
                    ...
                    <span style={{ ...ACTION_BUTTON_TEXT_STYLE, lineHeight: "normal" }}>キャンセル</span>
                  </Button>
                  <Button
                    variant="ghost"
                    className="border border-transparent p-0"
