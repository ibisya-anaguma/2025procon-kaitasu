...
export default function SubscriptionListPage() {
  ...
  return (
    <div className="flex-1 bg-white p-6 ml-[232px] min-h-screen" data-oid="subscription-list-page">
      <div className="mx-auto w-[903px]" data-oid="subscription-list-content">
        <div
          ...
          {subscriptionEntries.length === 0 ? (
            <div className="flex h-[160px] items-center justify-center" data-oid="subscription-list-empty">
              <span
                style={{
                  color: "#ADADAD",
            ...
            subscriptionEntries.map((entry) => (
              <div key={`subscription-entry-${entry.productId}`} className="flex items-center gap-8" data-oid="subscription-list-row">
                <span
                  style={{
                    color: "var(--, #101010)",
                    fontFamily: '"BIZ UDPGothic"',
                ...
                <div className="flex items-center gap-6 flex-1" data-oid="subscription-list-product">
                  <div className="overflow-hidden rounded bg-white flex items-center justify-center" style={{ width: "160px", height: "106px" }}>
                    <Image
                ...
                <button
                  ...
                  onClick={() => onRemoveSubscriptionEntry(entry.productId)}
