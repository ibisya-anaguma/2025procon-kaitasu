...
const OrderPage = ({ onNavigate }: OrderPageProps) => (
  <div className="flex-1 bg-white p-6 ml-[232px]" data-oid="syv6qb8">
    <div className="max-w-sm mx-auto" data-oid="9cyq3uk">
      ...
      <Card className="p-4 mb-4 bg-white border-2 border-[#fda900] rounded-lg" data-oid="jk:2_ry">
        <div className="flex items-start justify-between" data-oid="ih9dsxw">
          <div data-oid="r6l2mt0">
            <h3 className="font-medium mb-2 text-sm flex items-center" data-oid="fp4z1m-">
      ...
      <Card className="p-4 mb-4 bg-white border-2 border-[#fda900] rounded-lg" data-oid="8zvem9v">
      ...
      <Card className="p-4 mb-6 bg-white border-2 border-[#fda900] rounded-lg" data-oid="a13j9dc">
        <h3 className="font-medium mb-2 text-sm flex items-center" data-oid="qfwuago">
